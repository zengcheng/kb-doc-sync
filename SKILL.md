...
# 通过 display 格式链接提取
npx git@github.com:zengcheng/kb-doc-sync.git pull "https://kb.cvte.com/display/SPACE/Page+Title"

# 交互模式
npx git@github.com:zengcheng/kb-doc-sync.git
```
...
```bash
# 上传 Markdown 到指定父页面下
npx git@github.com:zengcheng/kb-doc-sync.git push \
